...
<h1 style="text-align: center">Pas recept aan</h1>
<div class="formbold-main-wrapper">
    <!-- Author: FormBold Team -->
    <!-- Learn More: https://formbold.com -->
    <div class="formbold-form-wrapper">
      <form method="POST" action="/recepten/{{$recept->id}}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
          <div class="formbold-input-flex">
            <div>
                ...
                />
                <label for="auteur" class="formbold-form-label"> Naam van auteur </label>
            ...
            <div>
                ...
                class="formbold-form-input"
                />
                <label for="titel" class="formbold-form-label"> Titel van recept </label>
          ...
          <div class="formbold-input-flex">
            <div>
                ...
                name="kooktijd"
                id="kooktijd"
                value="{{$recept->kooktijd}}"
                class="formbold-form-input"
                />
                <label for="kooktijd" class="formbold-form-label"> Kooktijd </label>
          ...
          <div class="formbold-input-file">
            <label for="body" class="formbold-input-label">
                ...
                {{$recept->body}}
                <input type="file" name="body" id="body">
            </label>
          </div>
